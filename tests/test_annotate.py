...
from ftm_analyze.annotate import Annotation, Annotator, clean_text, make_fingerprints
...
def test_annotate_util():
    assert make_fingerprints({model["Person"]}, ["Mrs. Jane Doe"]) == {
        "mrs. jane doe",
        "doe jane",
    }
